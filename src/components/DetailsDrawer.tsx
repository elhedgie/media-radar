      ...
      >
        ...
        <div className={styles["details-modal__content"]}>
          ...
          <section className="details-stats">
            <div>
              <p className="details-stat-label">Подписчики</p>
              <p className="details-stat-value">{holding.subscribers ?? "—"}</p>
            </div>
            <div>
              <p className="details-stat-label">Средний охват</p>
              <p className="details-stat-value">{holding.reach ?? "—"}</p>
            </div>
          </section> */}
